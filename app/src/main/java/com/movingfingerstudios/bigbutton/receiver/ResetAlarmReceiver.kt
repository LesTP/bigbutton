package com.movingfingerstudios.bigbutton.receiver
...
import com.movingfingerstudios.bigbutton.data.FinalizedDay
import com.movingfingerstudios.bigbutton.data.TrackingMetadata
...
class ResetAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_RESET_CHECK = "com.movingfingerstudios.bigbutton.ACTION_RESET_CHECK"
    ...
    private suspend fun finalizePeriod(
        ...
        dao.getMetadata(TrackingMetadata.KEY_TRACKING_START_DATE) ?: return
