package com.movingfingerstudios.bigbutton.widget
 ...
 * - resetHour: Int - hour of day for reset (0-23, default: 23)
 * - resetMinute: Int - minute of hour for reset (0-59, default: 59)
 */
object BigButtonStateDefinition : GlanceStateDefinition<Preferences> {
    ...
    const val DEFAULT_RESET_HOUR = 23  // 11:59 PM
    const val DEFAULT_RESET_MINUTE = 59
